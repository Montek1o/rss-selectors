...
export default function winGame() {
  const stateLevels: Array<string> = [localStorage.getItem('level1'), localStorage.getItem('level2'), localStorage.getItem('level3'), localStorage.getItem('level4'), localStorage.getItem('level5'), localStorage.getItem('level6'), localStorage.getItem('level7'), localStorage.getItem('level8'), localStorage.getItem('level9'), localStorage.getItem('level10')] as Array<string>;
  
  function isCompleted(element: string): boolean {
    return element == 'completed';
  }

  if (stateLevels.every(isCompleted)) {
